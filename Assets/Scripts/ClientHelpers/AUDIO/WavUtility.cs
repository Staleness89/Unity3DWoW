...
public class WavUtility
{
    ...
    public static AudioClip ToAudioClip(Stream inStream)
    {
        var b = new byte[inStream.Length];
        inStream.Read(b, 0, b.Length);

        int subchunk1 = BitConverter.ToInt32(b, 16);
        UInt16 audioFormat = BitConverter.ToUInt16(b, 20);
        ...
        MemoryStream mp3stream = new MemoryStream(b);
        ...
        var b2 = new byte[wavstream.Length];
        wavstream.Read(b2, 0, b2.Length);
        return ToAudioClip(b2, 0);
    }
