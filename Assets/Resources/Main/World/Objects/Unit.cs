...
public class Unit : MonoBehaviour
{
    ...
    public bool IsMovementBlocked
    {
        get
        {
            return false;  //Character.states[EntityStateType.Root].InEffect || Character.states[EntityStateType.Stun].InEffect;
        }
    }
    ...
    public bool IsAlive() { return true; } //(Character.DeathState == DeathState.Alive); }

    public bool IsDying() { return false; } //(Character.DeathState == DeathState.JustDied); }

    public bool IsDead() { return false; } //(Character.DeathState == DeathState.Dead || Character.DeathState == DeathState.Corpse); }
